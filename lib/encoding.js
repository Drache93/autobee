...
const AutobaseSystemInfo = getEncoding('@autobase-compat/info-v2')
...
exports.decodeAutobaseSystemInfo = decodeAutobaseSystemInfo
...
function decodeAutobaseSystemInfo(value) {
  return c.decode(AutobaseSystemInfo, value)
}
